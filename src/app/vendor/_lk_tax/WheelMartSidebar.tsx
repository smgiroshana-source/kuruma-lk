...
type LkTaxTab = 'overview' | 'products' | 'add' | 'bulk' | 'pos' | 'sales' | 'credit' | 'stocktake' | 'settings'
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: '_coming',    icon: '✏️', label: 'Write-offs', comingSoon: true },
    ],
  },
  {
    label: 'SUPPLIERS',
    items: [
      { id: '_coming', icon: '🏭', label: 'Suppliers',            comingSoon: true },
      { id: '_coming', icon: '💰', label: 'Payables & Payments',  comingSoon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '_coming', icon: '🚗', label: 'Vehicle History', comingSoon: true },
      { id: '_coming', icon: '🏢', label: 'Fleet Accounts',  comingSoon: true },
    ],
  },
  {
    label: 'FINANCE',
    items: [
      { id: '_coming', icon: '💵', label: 'Cash Reconciliation', comingSoon: true },
      { id: '_coming', icon: '🧾', label: 'Expenses',            comingSoon: true },
      { id: '_coming', icon: '📊', label: 'Reports',             comingSoon: true },
    ],
  },
]
