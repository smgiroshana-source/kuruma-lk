...
function printInvoice(sale: any, vendor: any, format: 'a4' | 'thermal', settings?: any) {
  ...
  const a4Style = `@page{size:A4;margin:20mm 25mm}*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Segoe UI',Arial,sans-serif;font-size:14px;color:#000;font-weight:600;width:620px;max-width:100%;margin:0 auto}.header{text-align:center;padding:15px 0 10px;margin-bottom:10px}.shop-name{font-size:24px;font-weight:900}table{width:100%;border-collapse:collapse;margin:10px 0}th{text-align:left;font-size:11px;font-weight:900;padding:6px 4px;border-bottom:1px dashed #000}td{padding:7px 4px;font-size:13px;font-weight:600}.text-right{text-align:right}.totals{padding-top:8px;margin-top:8px}.total-row{display:flex;justify-content:space-between;padding:4px 0;font-size:14px;font-weight:700}.grand-total{font-weight:900;font-size:22px;padding:10px 0;margin-top:5px;border-top:1px dashed #000}.footer{text-align:center;padding:15px 0;font-size:12px;font-weight:600;margin-top:15px}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}`
...
${parseFloat(sale.balance_due) > 0 ? `<div style="text-align:right;font-weight:900;font-size:${isThermal ? '14px' : '16px'};margin-top:8px;padding:8px 0">BALANCE DUE: Rs.${parseFloat(sale.balance_due).toLocaleString()}</div>` : ''}
${termsHtml}
