...
function printInvoice(sale: any, vendor: any, format: 'a4' | 'thermal', settings?: any) {
  ...
  const a4Style = `@page{size:A4;margin:15mm 20mm}*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Segoe UI',Arial,sans-serif;font-size:16px;color:#000;font-weight:700;width:650px;max-width:100%;margin:0 auto}.header{text-align:center;padding:15px 0 10px;margin-bottom:10px}.shop-name{font-size:28px;font-weight:900}table{width:100%;border-collapse:collapse;margin:10px 0}th{text-align:left;font-size:14px;font-weight:900;padding:8px 4px;border-bottom:1px dashed #000}td{padding:9px 4px;font-size:15px;font-weight:700}.text-right{text-align:right}.totals{padding-top:8px;margin-top:8px}.total-row{display:flex;justify-content:space-between;padding:5px 0;font-size:16px;font-weight:800}.grand-total{font-weight:900;font-size:26px;padding:10px 0;margin-top:5px;border-top:1px dashed #000}.balance-due{font-weight:900;font-size:20px;text-align:right;margin-top:10px;padding:10px;border:2px dashed #000}.footer{text-align:center;padding:15px 0;font-size:13px;font-weight:600;margin-top:15px}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}`
