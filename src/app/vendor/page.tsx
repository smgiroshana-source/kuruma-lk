...
function printInvoice(sale: any, vendor: any, format: 'a4' | 'thermal', settings?: any) {
  ...
  const a4Style = `@page{size:A4;margin:20mm 25mm}*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;font-size:13px;color:#222;font-weight:400;max-width:650px;margin:0 auto;padding:30px 40px}@media print{body{padding:0;max-width:100%}}
